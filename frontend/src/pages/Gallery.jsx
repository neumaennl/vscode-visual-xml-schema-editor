      ...
      <div className="flex h-screen flex-col overflow-hidden">
        ...
        <div className="thin-scroll flex-1 overflow-y-auto p-6">
          ...
          <div className="grid grid-cols-1 gap-5 lg:grid-cols-2 xl:grid-cols-3">
            ...
            <Section
              title="6 — Visual legend"
              subtitle="Conventions reused from the current renderer"
            >
              <ul className="space-y-2 font-ui text-[12px] text-[var(--vsc-text-dim)]">
                <li className="flex items-center gap-3">
                  <svg width="50" height="20">
                    <rect x="0" y="2" width="48" height="16" stroke="#e7e7e7" fill="none" />
                  </svg>
                  Solid box · required (minOccurs ≥ 1)
                </li>
                <li className="flex items-center gap-3">
                  <svg width="50" height="20">
                    <rect
                  ...
                  Dashed box · optional (minOccurs = 0)
                </li>
                <li className="flex items-center gap-3">
                  <svg width="50" height="20">
                    <rect x="6" y="6" width="40" height="12" stroke="#e7e7e7" fill="none" />
                    <rect x="3" y="3" width="40" height="12" stroke="#e7e7e7" fill="none" />
                    <rect x="0" y="0" width="40" height="12" stroke="#e7e7e7" fill="none" />
                  </svg>
                  Stacked · repeating (maxOccurs &gt; 1)
                </li>
                <li className="flex items-center gap-3">
                  <svg width="50" height="20">
                    <polygon
                      points="8,0 50,0 50,18 8,18 0,9"
                      fill="none"
                      stroke="#e7e7e7"
                    />
                  </svg>
                ...
                <li className="flex items-center gap-3">
                  <svg width="50" height="20">
                    <polygon
                      points="6,2 44,2 50,9 44,17 6,17 0,9"
                      fill="none"
                      stroke="#e7e7e7"
                    />
                    <circle cx="18" cy="9" r="1.5" fill="#e7e7e7" />
                    <circle cx="25" cy="9" r="1.5" fill="#e7e7e7" />
                    <circle cx="32" cy="9" r="1.5" fill="#e7e7e7" />
                  </svg>
                  Compositor · sequence / choice / all
                </li>
                <li className="flex items-center gap-3">
                  <span className="grid h-4 w-4 place-items-center rounded-sm border border-[#e7e7e7] font-mono text-[10px]">
                    +
                  </span>
                  Collapsed children — click to expand
                </li>
              </ul>
            </Section>
          </div>
